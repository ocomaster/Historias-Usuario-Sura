...
<#--  <#if (bgCarousel.getData())?? && bgCarousel.getData() != "">
	<#assign bgCarousel = bgCarousel.getData() />
	<#assign bgCarousel = colorClass(bgCarousel, "bg", "") />
<#else>
  <#assign bgCarousel = "" />
</#if>  -->
...
<#--  <#if (BordeCard.getData.getData())?? && BordeCard.getData() != "">
    <#assign bordeCard = BordeCard.getData.getData() />
	<#assign bordeCard = colorClass(bgColor, "", "") />
<#else>
    <#assign bordeCard = "bg-color-primary-color-1" />
</#if>  -->
                ...
                <div class="container" >
                    <div class="d-flex"  >
                        <#list cards.getSiblings() as card>
                            ...
                            <div class="card ${positionCard} ${bgColorData} s-js-card-animation " style="transition: all 300ms ease !important; border-radius: ${borderRadius}px; box-shadow: 0 0 0 ${borderWidthValue}px ; " >
                                <div class="s-c-card_animacion_desplegable_content "  style="border-color: blue; " >
                                    ...
                                    <div class="s-c-card_animacion_desplegable_card_text" style="width: auto">
                                        <div class="s-c-card_animacion_desplegable_rich-text s-s-animacion_desplegable_rich-text ${paragrahColorData}" style=" var(font-size: 1.375rem) ">
                                            ${paragraphData}
                                        </div>
                                    </div>
