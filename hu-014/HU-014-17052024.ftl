                ...
                <div class="container" >
                    <div class="d-flex "  >
                        <#list cards.getSiblings() as card>
                            ...
                            <div class="card ${positionCard} ${bgColorData} s-js-card-animation card_redes_sociales  " style="transition: all 300ms ease !important; border-radius: ${borderRadius}px;" >
