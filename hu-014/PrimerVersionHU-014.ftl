                ...
                <div class="container">
                    <div class="d-flex">
                        <#list cards.getSiblings() as card>
                            ...
                            <div class="card ${positionCard} ${bgColorData} s-js-card-animation">
                                <div class="s-c-card_animacion_desplegable_content">
                                    <div class="s-c-card_animacion_desplegable_title ${titleColorData}">
                                        <#if haveTitle>
                                            <${typeTitleData}>
                                                ${stringUtil.shorten(htmlUtil.stripHtml(titleData), 35)}
                                            </${typeTitleData}>
                                        </#if>
                                    </div>
                                    ...
                                    <div class="s-c-card_animacion_desplegable_card_text">
                                        <div class="s-c-card_animacion_desplegable_rich-text s-s-animacion_desplegable_rich-text ${paragrahColorData}">
                                            ${paragraphData}
                                        </div>
                                    </div>
                                ...
                                <div class="card_img_${positionCard} alternative_img_${positionCard}">
                                    <#if haveImgDesktop && haveImgMobileContract>
                                        <img class="s-c-card_animacion_desplegable_img_desktop" src="${imgDesktopData}"  alt="${imgDesktopAlt}">
