                                ...
                                <#list navigationEntry.getChildren() as children_nav>
                                            ...
                                            <div class="s-o-dropdown__content s-js-hidden" aria-labelledby="dropdown-subheader-${count}" id="dropdown-subheader-${count}-drop-content">
                                                ...
                                                <#assign count++ />
                                                    <#list children_nav.getChildren() as subChildren_nav>
                                                        <li class="s-o-dropdown">
                                                            <a href="${subChildren_nav.getURL()}" class="s-o-dropdown__toggle s-c-header__sub-menu s-t-dropdown__toggle--inactive header-gtm" title="ir a ${subChildren_nav.getUnescapedName()}" ${subChildren_nav.getTarget()} id="header-arl-link-${count2}">
                                    ...
                                    <#else>
                                        <li class="s-o-dropdown__item-container">
                                            <a href="${children_nav.getURL()}" class="s-o-dropdown__item" class="ir a ${children_nav.getUnescapedName()} header-gtm" ${children_nav.getTarget()} id="header-arl-link-${count2}" >
                                                <span class="s-o-dropdown__item__left d-flex header-gtm">
                                                    <span class="s-o-dropdown__item__text txt-color-primary-color-2 header-gtm">${stringUtil.shorten(htmlUtil.stripHtml(children_nav.getUnescapedName()), 70, "")}</span>
                                                </span>
                                                <span class="s-o-dropdown__item__right">
                                                </span>
                                            </a>
