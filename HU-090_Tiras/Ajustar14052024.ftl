...
<#--  Se agrega ajuste para el centrado, justificacion y alineamiento del componente en dispositivos moviles V2 -->
<style>
@media (max-width: 767px) {
    .s-c-carouselStrip__item {
...
*/
                        ...
                        <#-- Se agrega ajuste para el centrado, justificacion y alineamiento del componente en Escritorio  V2-->
                                <div class="s-c-carouselStrip__item bg-color-primary-color-2 tira-carrusel-accesos-f-gtm-${contentId}" style="display: flex; justify-content: center; align-items: center;">
                                    <div class="d-flex tira-carrusel-accesos-f-gtm-${contentId} centrando"  >
