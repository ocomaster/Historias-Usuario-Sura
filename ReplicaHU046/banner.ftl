...
<div class="fragment_743">    
    <section class="s-c-banner-image-expand container">
        <div class="container d-flex bg-color-${bannerBackgroundColor}">
            <!-----------------divisor para el texto------------------->
            <div class="s-s-banner-expand-text ${contentOrientation}">
                ...
                <!------------------divisor tag------------------->
                [#if enableTag]
                    <div class="s-c-banner-expand-tag d-flex">
                ...
                [#if enableButton]
                    <div class="s-c-banner-expand-btn">
                        <a title="${buttonText}" class="s-o-btn s-t-btn--fw-mobil ${buttonType} ${buttonSize} ${buttonState} banner-image-expand-gtm-${elementId}" href="${buttonURL}" title="Botón" target="_${openingType}">
                            ...
                            [/#if]
                            <span class="banner-image-expand-gtm-${elementId}">${stringUtil.shorten(htmlUtil.stripHtml(buttonText), 20)}</span>
                            [#if enableRightIcon]
