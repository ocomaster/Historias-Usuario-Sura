...
<div class="fragment_504">
	<section class="s-c-banner-overflowed bg-color-${bannerBackgroundColor}">
        <div class="s-c-banner-overflowed-content d-flex">
            ...
            <div class="s-s-banner-flowed-text ${contentOrientation}">
                ...
                <!------------------divisor tag------------------->
                [#if enableTag]
                    <div class="s-c-banner-overflowed-tag d-flex">
                ...
                [#if enableButton]
                    <div class="s-c-banner-overflowed-btn">
            ...
            <div class="s-c-banner-overflowed-image ${imageOrientation}">
